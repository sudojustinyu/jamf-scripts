...
sudo unzip -o /Library/Application\ Support/JAMF/Waiting\ Room/Zscaler-osx-4.2.0.255-installer.app.zip -d /Users/Shared/

#run the zscaler install command with arguments
#https://help.zscaler.com/z-app/customizing-zscaler-app-install-options-macos
sudo sh /Users/Shared/Zscaler-osx-4.2.0.255-installer.app/Contents/MacOS/installbuilder.sh --cloudName zscalertwo --mode unattended --unattendedmodeui none

#cleanup, delete the unzipped file
rm -rf /Users/Shared/Zscaler-osx-4.2.0.255-installer.app
