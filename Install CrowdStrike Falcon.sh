...
then
    ...
    /Applications/Falcon.app/Contents/Resources/falconctl license ${CS_CCID}
    echo "Setting grouping tag"
	/Applications/Falcon.app/Contents/Resources/falconctl grouping-tags set ${grouping_tag}
	echo "Unloading"
