        ...
        * ) # Catch-all (i.e., used when `welcomeDialog` is set to `video`, `messageOnly` or `false`)
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    {
                        "listitem": "Flic",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_3f4cacf57fdeef6c4a4621112f7cc919c5c01553b8260d98ba8aa16a1c37d0ca",
                        "progresstext": "Flic let’s you create automations simply, for the whole family to enjoy.",
                        "trigger_list": [
                            {
                                "trigger": "flic",
                                "validation": "/Applications/Flic.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "Keyboard Maestro",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_3842356fce27f02254e2318ff7feef8c3aa06e845ef2bc1e2ec23dfe661e53fd",
                        "progresstext": "Automate applications or web sites, text or images, simple or complex, on command or scheduled.",
                        "trigger_list": [
                            {
                                "trigger": "keyboardmaestro",
                                "validation": "/Applications/Keyboard Maestro.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "Look Creator",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_a068d4077928b4fe78a9eb859aeff533d9ba18a41a5a15789ee32d1e97715d8b",
                        "progresstext": "Get your product images online 5 times faster than traditional photoshoots.",
                        "trigger_list": [
                            {
                                "trigger": "lookcreator",
                                "validation": "/Applications/Look Creator.app/Contents/Info.plist"
                            }
                        ]
                    },                                                                                                                                          
                    {
