        ...
        * ) # Catch-all (i.e., used when `welcomeDialog` is set to `video`, `messageOnly` or `false`)
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    {
                        "listitem": "Microsoft Office 365",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_10e2ebed512e443189badcaf9143293d447f4a3fd8562cd419f6666ca07eb775",
                        "progresstext": "Microsoft Office 365 for Mac gives you the essentials to get it all done with the classic versions of the Office applications.",
                        "trigger_list": [
                            {
                                "trigger": "microsoftOffice365",
                    ...
                    {
                        "listitem": "Kelvin",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_6c0e198068a445d0ed77d2d033f3f7f487d4aca9644844fb72afad43207710b9",
                        "progresstext": "The first step of putting all the images to Creative Force and pushing them through production.",
                        "trigger_list": [
                            {
                                "trigger": "kelvin",
                                "validation": "/Applications/Kelvin.app/Contents/Info.plist"
                            }
                        ]
                    },                    
                    {
                    ...
                    {
                        "listitem": "Capture One",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_05791c3730d7663180eb2ae89c851c6af2f42fff63597a653f01e9962d4c2961",
                        "progresstext": "The gold standard for photo editing. Trusted by pros.",
                        "trigger_list": [
                            {
                                "trigger": "captureone22",
                                "validation": "/Applications/Capture One 22.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "Helicon Focus",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_3ad11b6f27fc3978abede90df14029c0fbffe2927d1cb19302f99446685c2ff5",
                        "progresstext": "Automate applications or web sites, text or images, simple or complex, on command or scheduled.",
                        "trigger_list": [
                            {
                                "trigger": "heliconfocus",
                                "validation": "/Applications/HeliconFocus.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
