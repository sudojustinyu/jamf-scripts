...
brandingBanner="/Users/Shared/SAKS_WALLPAPER_LAPTOP.jpg"
brandingBannerDisplayText="false"
brandingIconLight="/Users/Shared/sakslogo.jpeg"
brandingIconDark="/Users/Shared/sakslogo.jpeg"

# [SYM-Helper] IT Support Variables - Use these if the default text is fine but you want your org's info inserted instead
supportTeamName="SCS Workplace Services team"
#supportTeamPhone=""
supportTeamEmail="helpme.it@saks.com"
...
#supportTeamErrorKB="[${supportKB}](https://saks.atlassian.net/wiki/spaces/ITOPS/overview${supportKB}#Failures)"
#supportTeamHelpKB="\n- **IT Knowledge Base Articles:** ${supportKB}"
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    },
                    {
                        ...
                        "progresstext": "Log into Chrome with your Saks email account to backup your bookmarks and settings",
                        "trigger_list": [
                            {
                                "trigger": "googlechrome",
                                "validation": "/Applications/Google Chrome.app/Contents/Info.plist"
                    ...
                    {
                       "listitem": "Cyberark",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_2d97d3271057a5fc0195e2a11a8a56dacf9a0e81b19da1542ad5627315376d11",
                        "progresstext": "Cyberark grants you temporary administrative access on your computer. Whenever you launch something that requires elevated privileges, you will be prompted to enter a brief justification as to why you need admin privileges.",
                        "trigger_list": [
                            {
                                "trigger": "cyberark",
                                "validation": "None"
                    ...
                    },
                    {
                        ...
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_ffd6fadae961d15ab864d27730713dd143c20a5214f964eef7351b2ddab0de19",
...
function finalise(){
    ...
    if [[ "${jamfProPolicyTriggerFailure}" == "failed" ]]; then
        ...
        if [[ "${failureDialog}" == "true" ]]; then
            ...
            failureMessage="Something went wrong, ${loggedInUserFirstname}. \n\nThe following failed:  \n${jamfProPolicyNameFailures} \n\n\n\nFor assistance, please contact the ${supportTeamName} via Jira @"
