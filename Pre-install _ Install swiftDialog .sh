...
scriptLog="${4:-"/var/tmp/org.saks.log"}"
...
if [[ -f "/Library/Application Support/Dialog/Dialog.png" ]]; then
    updateScriptLog "The file '/Library/Application Support/Dialog/Dialog.png' already exists; will run this other command."
    exit 0
else
...
updateScriptLog "Validate 'Dialog.app' …"
if [ ! -e "/Library/Application Support/Dialog/Dialog.app" ]; then
	updateScriptLog "The file '/Library/Application Support/Dialog/Dialog.app' does NOT exist; proceeding …"
    sudo jamf policy -id 360
    if [ ! -e "/Library/Application Support/Dialog/Dialog.app" ]; then
    	updateScriptLog "The file '/Library/Application Support/Dialog/Dialog.app' does NOT exist; exiting …"
    	exit 0
    else
    	updateScriptLog "The file '/Library/Application Support/Dialog/Dialog.app' exists; will proceed."
   	fi
else
    updateScriptLog "The file '/Library/Application Support/Dialog/Dialog.app' already exists; will proceed."
fi
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# Exit
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
