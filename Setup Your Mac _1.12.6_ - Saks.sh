...
supportKB="https://saks.atlassian.net/servicedesk/customer/portal/6"
        ...
        "${configurationThreeName}" )
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    {
                        "listitem": "Background",
                        "icon": "944ace85947e5ab12c481569d2b7c920d708cefc19efaea96a177eb541b78a4c",
                        "progresstext": "Setting Desktop Background …",
                        "trigger_list": [
                            {
                                "trigger": "hbcdesktoppr",
                                "validation": "None"
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    },
                    {
                        ...
                        "icon": "02e8f6c649784d8fa656480b0c95b57a966eb544a765b4eeed67020405bb420d",
                    ...
                    {
                        "listitem": "Slack",
                        "icon": "0f918a4be88756a6a33ce36cc8b35166996fa4223545bb642537785de47bdd92",
                    ...
                    },
                    {
                        ...
                        "icon": "ffd6fadae961d15ab864d27730713dd143c20a5214f964eef7351b2ddab0de19",
...
function finalise(){
    ...
    if [[ "${jamfProPolicyTriggerFailure}" == "failed" ]]; then
        ...
        if [[ "${failureDialog}" == "true" ]]; then
            ...
            dialogUpdateFailure "message: Something went wrong, ${loggedInUserFirstname}. \n\nThe following failed:  \n${jamfProPolicyNameFailures} \n\n\n\nFor assistance, please contact the ${supportTeamName} via Jira @ https://saks.atlassian.net/servicedesk/customer/portal/6/create/1819 "
