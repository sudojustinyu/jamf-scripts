...
scriptLog="${4:-"/var/log/org.so5.log"}"                        # Parameter 4: Script Log Location [ /var/log/org.churchofjesuschrist.log ] (i.e., Your organization's default location for client-side logs)
...
completionActionOption="${7:-"sleep 10"}"                               # Parameter 7: Completion Action [ wait | sleep (with seconds) | Shut Down | Shut Down Attended | Shut Down Confirm | Restart | Restart Attended (default) | Restart Confirm | Log Out | Log Out Attended | Log Out Confirm ]
...
brandingBanner="https://media.licdn.com/dms/image/D4E16AQFM0AUcuqIX5Q/profile-displaybackgroundimage-shrink_200_800/0/1679080106434?e=2147483647&v=beta&t=UE0WtODVl-_K_gF7XxrR5p-qvnUI53doEmKCoGjIX-o" # Image by pikisuperstar on Freepik
...
supportTeamName="Workplace Services"
#supportTeamPhone="+1 (801) 555-1212"
supportTeamEmail="workplaceservices@saks.com"
#supportTeamWebsite="https://saks.atlassian.net/servicedesk/customer/portal/6"
#supportTeamHyperlink="[${supportTeamWebsite}](https://saks.atlassian.net/servicedesk/customer/portal/6})"
supportKB="https://saks.atlassian.net/wiki/spaces/ITOPS/overview"
supportTeamErrorKB="[${supportKB}](https://saks.atlassian.net/wiki/spaces/ITOPS/overview)"
...
if [[ -n "${brandingBanner}" ]]; then
    ...
    bannerImage="https://media.licdn.com/dms/image/D4E16AQFM0AUcuqIX5Q/profile-displaybackgroundimage-shrink_200_800/0/1679080106434?e=2147483647&v=beta&t=UE0WtODVl-_K_gF7XxrR5p-qvnUI53doEmKCoGjIX-o" # Image by pikisuperstar on Freepik
fi
                ...
                "steps": [
                    {
                        ...
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_8f05a2f82307e379469e446633f53a9c9a7864ab156cacd5d736b08ea13295eb",
                    ...
                    },
                    {
                       "listitem": "Initial Configuration",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_4723e3e341a7e11e6881e418cf91b157fcc081bdb8948697750e5da3562df728",
                        "progresstext": "Initializing Configuration …",
                        "trigger_list": [
                            {
                                "trigger": "remove-apps",
                    ...
                    {
                        "listitem": "Rosetta",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_8bac19160fabb0c8e7bac97b37b51d2ac8f38b7100b6357642d9505645d37b52",
                        "progresstext": "Rosetta enables a Mac with Apple silicon to use apps built for a Mac with an Intel processor.",
                        "trigger_list": [
                            {
                                "trigger": "rosetta",
                    ...
                    },
                    {
                        ...
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_9023a5e9c381f41b4dee0b32b173c8c2f09b4b25c9312c4d1d92421e0491a773",
                        "progresstext": "You’ll enjoy next-gen protection with Crowdstrike which doesn’t rely on signatures to catch malware.",
                        "trigger_list": [
                            {
                                "trigger": "so5crowdstrike",
                                "validation": "/Applications/Falcon.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "PrinterLogic",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_02e8f6c649784d8fa656480b0c95b57a966eb544a765b4eeed67020405bb420d",
                        "progresstext": "Use PrinterLogic to add printers when you are in the office …",
                        "trigger_list": [
                            {
                                "trigger": "printer-logic",
                                "validation": "None"
                            }
                        ]
                    },
                     {
                        "listitem": "Splashtop",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_190e2b728e50e2bb4ef0abf1c2c5305faebb8153ceb181857199f0e0efad942c",
                        "progresstext": "Reach out to your PBP for any questions about benefits",
                        "trigger_list": [
                            {
                                "trigger": "so5splashtop",
                    ...
                    },
                     {
                        ...
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_8c04999d2f6b432f0a31a5bb23193b30f6a64e364a54421817deba986d632bc2",
                    ...
                    {
                        "listitem": "Google Chrome",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_12d3d198f40ab2ac237cff3b5cb05b09f7f26966d6dffba780e4d4e5325cc701",
                        "progresstext": "Log into Chrome with your work email account to backup your bookmarks and settings",
                        "trigger_list": [
                            {
                                "trigger": "googlechrome",
                                "validation": "/Applications/Google Chrome.app/Contents/Info.plist"
                    ...
                    },
                    {
                        ...
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_25ae65f32ea74dd19864ba07b39cab5e120443c699ab968b2e39c0ac03f8c41c",
                    ...
                    {
                        "listitem": "Slack",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_0f918a4be88756a6a33ce36cc8b35166996fa4223545bb642537785de47bdd92",
                        "progresstext": "You can use Slack to quickly connect with your co-workers",
                        "trigger_list": [
                            {
                                "trigger": "slack",
                    ...
                    {
                        "listitem": "A Better Finder Rename",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_de4c2cf9fb73983efa781c3339e8f6f4882347259f45819f4764f1a3a574d9d2",
                        "progresstext": "Use the most powerful and complete Mac file renaming application on the market.",
                        "trigger_list": [
                            {
                                "trigger": "better-finder-rename",
                                "validation": "/Applications/A Better Finder Rename 11.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "Box Sync",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_f9fd8e28b39f90189f467de2ac53300a958c5359b0b1cb235501722e1b365df1",
                        "progresstext": "Keeps all your files safe and secure in the cloud.",
                        "trigger_list": [
                            {
                                "trigger": "boxsync",
                                "validation": "/Applications/Box Sync.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "NameChanger",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_26c649de49f82be8d1868bf4dec5fad7b8547593dbdfa59e02b2a7287edf85df",
                        "progresstext": "Rename a list of files quickly and easily. See how the names will change as you type.",
                        "trigger_list": [
                            {
                                "trigger": "namechanger",
                                "validation": "/Applications/NameChanger.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "Wacom Tablet",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_2f77d19e482ea977801d3fea209bba9c15c4b86dc6354640a731fc99686c9ad7",
                        "progresstext":  "Wacom Makes The World A More Creative Place With Tools For Artists & Creative Companies.",
                        "trigger_list": [
                            {
                                "trigger": "wacom",
                                "validation": "/Applications/Wacom Tablet.localized/Wacom Center.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "Hue",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_d2d87defca056d39182831d84b9f898ac3116ee7dce26850351845eaf6af80a3",
                        "progresstext": "Best in class software for managing your photo studio!",
                        "trigger_list": [
                            {
                                "trigger": "hue",
                                "validation": "/Applications/Hue.app/Contents/Info.plist"
                            }
                        ]
                    },
                    {
                        "listitem": "iProfiler",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_aeca6efd1b714f416fbce5f3c0acfee5d1d518f939da1c42f07d6b7b7a265909",
                        "progresstext": "Create the highest quality professional color profiles.",
                        "trigger_list": [
                            {
                                "trigger": "iProfiler",
                                "validation": "/Applications/i1Profiler/i1Profiler.app/Contents/Info.plist"
                            }
                        ]
                    },                                                                                                                                                     
                    {
                        "listitem": "Background & Login Icon",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_4e358dbfb85118bf469722c264111b33ae647ecba112eeb89953fa0e0dccebe9",
                        "progresstext": "Setting Desktop Background & Login Icon …",
                        "trigger_list": [
                            {
                                "trigger": "so5desktoppr",
                                "validation": "None"
                            },
                            {
                            	"trigger": "so5loginicon",
                                "validation": "None"
                            }
                        ]
                    },
                    {
                        "listitem": "Final Configuration",
                        "icon": "https://use2.ics.services.jamfcloud.com/icon/hash_4723e3e341a7e11e6881e418cf91b157fcc081bdb8948697750e5da3562df728",
                        "progresstext": "Finalizing set up...",
                        "trigger_list": [
                            {
                                "trigger": "thebaydock",
                                "validation": "None"
