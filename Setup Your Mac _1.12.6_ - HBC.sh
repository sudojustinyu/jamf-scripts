...
# Branding overrides
brandingBanner="/Users/Shared/hbcbanner.png"
brandingBannerDisplayText="true"
brandingIconLight="/Users/Shared/hbclogo.png"
brandingIconDark="/Users/Shared/hbclogo.png"
        ...
        * ) # Catch-all (i.e., used when `welcomeDialog` is set to `video`, `messageOnly` or `false`)
            ...
            policyJSON='
            {
                "steps": [
                    ...
                    {
                       "listitem": "FileVault Disk Encryption",
                        "icon": "24157bb7b120d251d770ace0f67a9bedef7ec08b09a29c13192947efb39fead0",
                        "progresstext": "FileVault is built-in to macOS and provides full-disk encryption to help prevent unauthorized access to your Mac.",
                        "trigger_list": [
                            {
                                "trigger": "filevault",
                    ...
                    {
                        "listitem": "Adobe Acrobat Reader",
                        "icon": "23ff240b9a98439364c1145ccf4437faba1bcec57e5b8ab5628824f3b9103623",
                        "progresstext": "Use Adobe Acrobat Reader to view, print, and comment on PDF documents.",
                        "trigger_list": [
                            {
                                "trigger": "adobeAcrobatReader",
                                "validation": "/Applications/Adobe Acrobat Reader.app/Contents/Info.plist"
